...
data class CoinData(@PrimaryKey (autoGenerate = false) @SerializedName("id") val id: String,
                    ...
                    @ColumnInfo (name = "price_usd") @SerializedName("price_usd") val price: BigDecimal?,
                    @ColumnInfo (name = "available_supply") @SerializedName("available_supply") val availableSupply: BigDecimal?,
                    @ColumnInfo (name = "total_supply") @SerializedName("total_supply") val totalSupply: BigDecimal?,
                    ...
                    @ColumnInfo (name = "24h_volume_usd") @SerializedName("24h_volume_usd") val volume24h: BigDecimal?,
                    @ColumnInfo (name = "market_cap_usd") @SerializedName("market_cap_usd") val marketCap: BigDecimal?,
